 ...
 *
 * modified 2011-91-22 by Andreas Jansson
 * Added return 0 to the midifile() function. This was in order to
 * pass -Wall -pedantic as recommended in the document 'Writing R
 * Extensions'.
 */
#include "midifile.h"
#define NULLFUNC 0
